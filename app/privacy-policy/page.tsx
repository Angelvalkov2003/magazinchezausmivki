...
export default function PrivacyPolicyPage() {
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-stone-400 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white dark:bg-stone-400 rounded-lg shadow p-8 space-y-8">
          <div>
