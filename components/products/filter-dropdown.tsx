    ...
    <div className="relative" ref={dropdownRef}>
      <button
        ...
        className={`flex items-center gap-2 px-4 py-2.5 rounded-lg border border-gray-300 dark:border-gray-600 text-sm font-medium transition-all duration-200 min-w-[140px] justify-between ${
          hasActiveFilters
            ? "bg-sage text-white dark:bg-mustard border-sage dark:border-mustard hover:bg-sage/80 dark:hover:bg-mustard/80"
            : "bg-white dark:bg-sage text-gray-700 dark:text-gray-300 shadow-sm hover:bg-gray-50 dark:hover:bg-gray-700"
        }`}
      >
      ...
      {isOpen && (
        <div className="absolute top-full right-0 sm:right-0 left-0 sm:left-auto mt-2 w-[calc(100vw-2rem)] sm:w-80 bg-white dark:bg-sage border border-gray-200 dark:border-gray-700 rounded-lg shadow-lg z-50 max-h-[80vh] overflow-y-auto">
          <div className="p-4">
              ...
              <div className="flex items-center gap-3">
                <div className="flex-1">
                  ...
                  <input
                    ...
                    placeholder="0.00"
                    className="w-full rounded-md border border-gray-300 bg-white px-3 py-2 text-sm text-gray-700 shadow-sm focus:border-sage focus:outline-none focus:ring-1 focus:ring-sage dark:border-gray-600 dark:bg-gray-700 dark:text-gray-300"
                  />
                </div>
                <div className="flex-1">
                  <label className="block text-xs font-medium text-gray-700 dark:text-gray-300 mb-1">
                ...
                {collections.map((collection) => (
                  ...
                  >
                    <input
                      ...
                      className="h-4 w-4 text-mustard rounded border-gray-300 focus:ring-sage"
                    />
            ...
            <div className="flex gap-2 pt-3 border-t border-gray-200 dark:border-gray-700">
              <button
                onClick={handleApply}
                className="flex-1 px-4 py-2 text-sm font-medium text-white bg-sage dark:bg-mustard rounded-md hover:bg-sage/80 dark:hover:bg-mustard/80 transition-colors"
              >
                Приложи
              </button>
              <button
